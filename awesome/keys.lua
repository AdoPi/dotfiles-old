...
-- TODO(AdoPi): should change the layout with some keybindings
...
keys.globalkeys = gears.table.join(
    ...
    -- Swap screen focus
    awful.key({ modkey, ctrlkey,altkey }, "h", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey, ctrlkey, altkey }, "l", function () awful.screen.focus_relative(-1) end,
